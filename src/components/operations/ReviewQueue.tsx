...
export function QueueRow({
  ...
  return (
    <button
      ...
      className="w-full flex items-center gap-3 px-3.5 py-3 text-left border-b border-border-soft last:border-b-0 transition-colors hover:bg-hover"
      style={{
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="flex items-center gap-1.5 mt-1 flex-wrap">
          {status}
          {alert && (
            <span className="text-[10.5px] font-semibold" style={{ color: "var(--color-neg)" }}>{alert}</span>
          )}
        </div>
      </div>
    </button>
...
export function QueueSection({
  ...
  return (
    ...
    >
      ...
      {pending > 0 && (
        <span className="text-[10.5px] font-medium shrink-0" style={{ color: "var(--color-warn)" }}>
